...
RUN sed -i 's|"rpc-host-whitelist": ".*",|"rpc-host-whitelist": "seed1-lix6ah5c.b4a.run",|g' /etc/transmission-daemon/settings.json

EXPOSE 3000 7000 42069/tcp 42069/udp 5489/tcp 5489/udp 9091 51413/tcp 51413/udp

CMD ["transmission-daemon", "-p", "3000", "-g", "/etc/transmission-daemon/", "-u", "TheBomber", "-v", "ilovebomb54!!"]
